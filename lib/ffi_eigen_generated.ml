...
| Function (CI.Pointer x2, Returns CI.Void), "c_eigen_spmat_c_print" ->
  (fun x1 -> owl_stub_174_c_eigen_spmat_c_print (CI.cptr x1))
| Function (CI.Pointer x4, Returns (CI.Pointer x5)), "c_eigen_spmat_c_sqrt" ->
  (fun x3 -> CI.make_ptr x5 (owl_stub_173_c_eigen_spmat_c_sqrt (CI.cptr x3)))
| Function (CI.Pointer x7, Returns (CI.Pointer x8)), "c_eigen_spmat_c_neg" ->
  (fun x6 -> CI.make_ptr x8 (owl_stub_172_c_eigen_spmat_c_neg (CI.cptr x6)))
| Function (CI.Pointer x10, Returns (CI.Primitive CI.Complex32)),
  "c_eigen_spmat_c_sum" ->
  (fun x9 -> owl_stub_171_c_eigen_spmat_c_sum (CI.cptr x9))
| Function
    (CI.Pointer x12,
  ...
  (fun x11 x13 ->
    CI.make_ptr x14
      (owl_stub_170_c_eigen_spmat_c_div_scalar (CI.cptr x11) x13))
| Function
    (CI.Pointer x16,
  ...
  (fun x15 x17 ->
    CI.make_ptr x18
      (owl_stub_169_c_eigen_spmat_c_mul_scalar (CI.cptr x15) x17))
| Function
    (CI.Pointer x20,
  ...
  (fun x19 x21 ->
    CI.make_ptr x22
      (owl_stub_168_c_eigen_spmat_c_sub_scalar (CI.cptr x19) x21))
| Function
    (CI.Pointer x24,
...
| Function
  ...
  (fun x119 x121 x122 ->
    owl_stub_140_c_eigen_spmat_c_prune (CI.cptr x119) x121 x122)
| Function
    (CI.Pointer x124,
     Function
  ...
  (fun x123 x125 x126 ->
    owl_stub_139_c_eigen_spmat_c_reshape (CI.cptr x123) x125 x126)
| Function (CI.Pointer x128, Returns CI.Void), "c_eigen_spmat_c_uncompress" ->
  (fun x127 -> owl_stub_138_c_eigen_spmat_c_uncompress (CI.cptr x127))
| Function (CI.Pointer x130, Returns CI.Void), "c_eigen_spmat_c_compress" ->
  (fun x129 -> owl_stub_137_c_eigen_spmat_c_compress (CI.cptr x129))
| Function (CI.Pointer x132, Returns (CI.Primitive CI.Int)),
  "c_eigen_spmat_c_is_compressed" ->
  (fun x131 -> owl_stub_136_c_eigen_spmat_c_is_compressed (CI.cptr x131))
| Function (CI.Pointer x134, Returns CI.Void), "c_eigen_spmat_c_reset" ->
  (fun x133 -> owl_stub_135_c_eigen_spmat_c_reset (CI.cptr x133))
| Function
    (CI.Pointer x136,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  (fun x135 x137 x138 x139 ->
    owl_stub_134_c_eigen_spmat_c_set (CI.cptr x135) x137 x138 x139)
| Function
    (CI.Pointer x141,
     Function
       (CI.Primitive CI.Int64_t,
...
| Function
  ...
  (fun x184 x186 ->
    CI.make_ptr x187
      (owl_stub_117_c_eigen_spmat_d_div_scalar (CI.cptr x184) x186))
| Function
    (CI.Pointer x189,
  ...
  (fun x188 x190 ->
    CI.make_ptr x191
      (owl_stub_116_c_eigen_spmat_d_mul_scalar (CI.cptr x188) x190))
| Function
    (CI.Pointer x193,
  ...
  (fun x192 x194 ->
    CI.make_ptr x195
      (owl_stub_115_c_eigen_spmat_d_sub_scalar (CI.cptr x192) x194))
| Function
    (CI.Pointer x197,
  ...
  (fun x196 x198 ->
    CI.make_ptr x199
      (owl_stub_114_c_eigen_spmat_d_add_scalar (CI.cptr x196) x198))
| Function
    (CI.Pointer x201, Function (CI.Pointer x203, Returns (CI.Pointer x204))),
  "c_eigen_spmat_d_dot" ->
  (fun x200 x202 ->
    CI.make_ptr x204
      (owl_stub_113_c_eigen_spmat_d_dot (CI.cptr x200) (CI.cptr x202)))
| Function
    (CI.Pointer x206, Function (CI.Pointer x208, Returns (CI.Pointer x209))),
  "c_eigen_spmat_d_div" ->
  (fun x205 x207 ->
    CI.make_ptr x209
      (owl_stub_112_c_eigen_spmat_d_div (CI.cptr x205) (CI.cptr x207)))
| Function
    (CI.Pointer x211, Function (CI.Pointer x213, Returns (CI.Pointer x214))),
  "c_eigen_spmat_d_mul" ->
  (fun x210 x212 ->
    CI.make_ptr x214
      (owl_stub_111_c_eigen_spmat_d_mul (CI.cptr x210) (CI.cptr x212)))
| Function
    (CI.Pointer x216, Function (CI.Pointer x218, Returns (CI.Pointer x219))),
  "c_eigen_spmat_d_sub" ->
  (fun x215 x217 ->
    CI.make_ptr x219
      (owl_stub_110_c_eigen_spmat_d_sub (CI.cptr x215) (CI.cptr x217)))
| Function
    (CI.Pointer x221, Function (CI.Pointer x223, Returns (CI.Pointer x224))),
  "c_eigen_spmat_d_add" ->
  (fun x220 x222 ->
    CI.make_ptr x224
      (owl_stub_109_c_eigen_spmat_d_add (CI.cptr x220) (CI.cptr x222)))
| Function
    (CI.Pointer x226,
     Function (CI.Pointer x228, Returns (CI.Primitive CI.Int))),
  "c_eigen_spmat_d_equal_or_smaller" ->
  (fun x225 x227 ->
    owl_stub_108_c_eigen_spmat_d_equal_or_smaller (CI.cptr x225)
    (CI.cptr x227))
| Function
    (CI.Pointer x230,
  ...
  (fun x229 x231 ->
    owl_stub_107_c_eigen_spmat_d_equal_or_greater (CI.cptr x229)
    (CI.cptr x231))
| Function
    (CI.Pointer x234,
...
| Function
  ...
  (fun x292 x294 x295 ->
    owl_stub_87_c_eigen_spmat_d_prune (CI.cptr x292) x294 x295)
| Function
    (CI.Pointer x297,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  (fun x296 x298 x299 ->
    owl_stub_86_c_eigen_spmat_d_reshape (CI.cptr x296) x298 x299)
| Function (CI.Pointer x301, Returns CI.Void), "c_eigen_spmat_d_uncompress" ->
  (fun x300 -> owl_stub_85_c_eigen_spmat_d_uncompress (CI.cptr x300))
| Function (CI.Pointer x303, Returns CI.Void), "c_eigen_spmat_d_compress" ->
  (fun x302 -> owl_stub_84_c_eigen_spmat_d_compress (CI.cptr x302))
| Function (CI.Pointer x305, Returns (CI.Primitive CI.Int)),
  "c_eigen_spmat_d_is_compressed" ->
  (fun x304 -> owl_stub_83_c_eigen_spmat_d_is_compressed (CI.cptr x304))
| Function (CI.Pointer x307, Returns CI.Void), "c_eigen_spmat_d_reset" ->
  (fun x306 -> owl_stub_82_c_eigen_spmat_d_reset (CI.cptr x306))
| Function
    (CI.Pointer x309,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  (fun x308 x310 x311 x312 ->
    owl_stub_81_c_eigen_spmat_d_set (CI.cptr x308) x310 x311 x312)
| Function
    (CI.Pointer x314,
     Function
       (CI.Primitive CI.Int64_t,
...
| Function
  ...
  (fun x357 x359 ->
    CI.make_ptr x360
      (owl_stub_64_c_eigen_spmat_s_div_scalar (CI.cptr x357) x359))
| Function
    (CI.Pointer x362,
  ...
  (fun x361 x363 ->
    CI.make_ptr x364
      (owl_stub_63_c_eigen_spmat_s_mul_scalar (CI.cptr x361) x363))
| Function
    (CI.Pointer x366,
  ...
  (fun x365 x367 ->
    CI.make_ptr x368
      (owl_stub_62_c_eigen_spmat_s_sub_scalar (CI.cptr x365) x367))
| Function
    (CI.Pointer x370,
...
| Function
  ...
  (fun x402 x404 ->
    owl_stub_54_c_eigen_spmat_s_equal_or_greater (CI.cptr x402)
    (CI.cptr x404))
| Function
    (CI.Pointer x407,
...
| Function
  ...
  (fun x465 x467 x468 ->
    owl_stub_34_c_eigen_spmat_s_prune (CI.cptr x465) x467 x468)
| Function
    (CI.Pointer x470,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  (fun x469 x471 x472 ->
    owl_stub_33_c_eigen_spmat_s_reshape (CI.cptr x469) x471 x472)
| Function (CI.Pointer x474, Returns CI.Void), "c_eigen_spmat_s_uncompress" ->
  (fun x473 -> owl_stub_32_c_eigen_spmat_s_uncompress (CI.cptr x473))
| Function (CI.Pointer x476, Returns CI.Void), "c_eigen_spmat_s_compress" ->
  (fun x475 -> owl_stub_31_c_eigen_spmat_s_compress (CI.cptr x475))
| Function (CI.Pointer x478, Returns (CI.Primitive CI.Int)),
  "c_eigen_spmat_s_is_compressed" ->
  (fun x477 -> owl_stub_30_c_eigen_spmat_s_is_compressed (CI.cptr x477))
| Function (CI.Pointer x480, Returns CI.Void), "c_eigen_spmat_s_reset" ->
  (fun x479 -> owl_stub_29_c_eigen_spmat_s_reset (CI.cptr x479))
| Function
    (CI.Pointer x482,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  (fun x481 x483 x484 x485 ->
    owl_stub_28_c_eigen_spmat_s_set (CI.cptr x481) x483 x484 x485)
| Function
    (CI.Pointer x487,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  "c_eigen_spmat_s_get" ->
  (fun x486 x488 x489 ->
    owl_stub_27_c_eigen_spmat_s_get (CI.cptr x486) x488 x489)
| Function (CI.Pointer x491, Returns (CI.Primitive CI.Int64_t)),
  "c_eigen_spmat_s_nnz" ->
  (fun x490 -> owl_stub_26_c_eigen_spmat_s_nnz (CI.cptr x490))
| Function (CI.Pointer x493, Returns (CI.Primitive CI.Int64_t)),
  "c_eigen_spmat_s_cols" ->
  (fun x492 -> owl_stub_25_c_eigen_spmat_s_cols (CI.cptr x492))
| Function (CI.Pointer x495, Returns (CI.Primitive CI.Int64_t)),
  "c_eigen_spmat_s_rows" ->
  (fun x494 -> owl_stub_24_c_eigen_spmat_s_rows (CI.cptr x494))
| Function (CI.Primitive CI.Int64_t, Returns (CI.Pointer x497)),
  "c_eigen_spmat_s_eye" ->
  (fun x496 -> CI.make_ptr x497 (owl_stub_23_c_eigen_spmat_s_eye x496))
| Function (CI.Pointer x499, Returns CI.Void), "c_eigen_spmat_s_delete" ->
  (fun x498 -> owl_stub_22_c_eigen_spmat_s_delete (CI.cptr x498))
| Function
    (CI.Primitive CI.Int64_t,
     Function (CI.Primitive CI.Int64_t, Returns (CI.Pointer x502))),
  "c_eigen_spmat_s_new" ->
  (fun x500 x501 ->
    CI.make_ptr x502 (owl_stub_21_c_eigen_spmat_s_new x500 x501))
| Function (CI.Pointer x504, Returns CI.Void), "c_eigen_dsmat_z_print" ->
  (fun x503 -> owl_stub_20_c_eigen_dsmat_z_print (CI.cptr x503))
| Function
    (CI.Pointer x506,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  (fun x505 x507 x508 x509 ->
    owl_stub_19_c_eigen_dsmat_z_set (CI.cptr x505) x507 x508 x509)
| Function
    (CI.Pointer x511,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  "c_eigen_dsmat_z_get" ->
  (fun x510 x512 x513 ->
    owl_stub_18_c_eigen_dsmat_z_get (CI.cptr x510) x512 x513)
| Function (CI.Pointer x515, Returns CI.Void), "c_eigen_dsmat_z_delete" ->
  (fun x514 -> owl_stub_17_c_eigen_dsmat_z_delete (CI.cptr x514))
| Function
    (CI.Primitive CI.Int64_t,
     Function (CI.Primitive CI.Int64_t, Returns (CI.Pointer x518))),
  "c_eigen_dsmat_z_new" ->
  (fun x516 x517 ->
    CI.make_ptr x518 (owl_stub_16_c_eigen_dsmat_z_new x516 x517))
| Function (CI.Pointer x520, Returns CI.Void), "c_eigen_dsmat_c_print" ->
  (fun x519 -> owl_stub_15_c_eigen_dsmat_c_print (CI.cptr x519))
| Function
    (CI.Pointer x522,
     Function
       (CI.Primitive CI.Int64_t,
        Function
          (CI.Primitive CI.Int64_t,
           Function (CI.Primitive CI.Complex32, Returns CI.Void)))),
  "c_eigen_dsmat_c_set" ->
  (fun x521 x523 x524 x525 ->
    owl_stub_14_c_eigen_dsmat_c_set (CI.cptr x521) x523 x524 x525)
| Function
    (CI.Pointer x527,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  "c_eigen_dsmat_c_get" ->
  (fun x526 x528 x529 ->
    owl_stub_13_c_eigen_dsmat_c_get (CI.cptr x526) x528 x529)
| Function (CI.Pointer x531, Returns CI.Void), "c_eigen_dsmat_c_delete" ->
  (fun x530 -> owl_stub_12_c_eigen_dsmat_c_delete (CI.cptr x530))
| Function
    (CI.Primitive CI.Int64_t,
     Function (CI.Primitive CI.Int64_t, Returns (CI.Pointer x534))),
  "c_eigen_dsmat_c_new" ->
  (fun x532 x533 ->
    CI.make_ptr x534 (owl_stub_11_c_eigen_dsmat_c_new x532 x533))
| Function (CI.Pointer x536, Returns CI.Void), "c_eigen_dsmat_d_print" ->
  (fun x535 -> owl_stub_10_c_eigen_dsmat_d_print (CI.cptr x535))
| Function
    (CI.Pointer x538,
     Function
       (CI.Primitive CI.Int64_t,
        Function
          (CI.Primitive CI.Int64_t,
           Function (CI.Primitive CI.Double, Returns CI.Void)))),
  "c_eigen_dsmat_d_set" ->
  (fun x537 x539 x540 x541 ->
    owl_stub_9_c_eigen_dsmat_d_set (CI.cptr x537) x539 x540 x541)
| Function
    (CI.Pointer x543,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  "c_eigen_dsmat_d_get" ->
  (fun x542 x544 x545 ->
    owl_stub_8_c_eigen_dsmat_d_get (CI.cptr x542) x544 x545)
| Function (CI.Pointer x547, Returns CI.Void), "c_eigen_dsmat_d_delete" ->
  (fun x546 -> owl_stub_7_c_eigen_dsmat_d_delete (CI.cptr x546))
| Function
    (CI.Primitive CI.Int64_t,
     Function (CI.Primitive CI.Int64_t, Returns (CI.Pointer x550))),
  "c_eigen_dsmat_d_new" ->
  (fun x548 x549 ->
    CI.make_ptr x550 (owl_stub_6_c_eigen_dsmat_d_new x548 x549))
| Function (CI.Pointer x552, Returns CI.Void), "c_eigen_dsmat_s_print" ->
  (fun x551 -> owl_stub_5_c_eigen_dsmat_s_print (CI.cptr x551))
| Function
    (CI.Pointer x554,
     Function
       (CI.Primitive CI.Int64_t,
        Function
          (CI.Primitive CI.Int64_t,
           Function (CI.Primitive CI.Float, Returns CI.Void)))),
  "c_eigen_dsmat_s_set" ->
  (fun x553 x555 x556 x557 ->
    owl_stub_4_c_eigen_dsmat_s_set (CI.cptr x553) x555 x556 x557)
| Function
    (CI.Pointer x559,
     Function
       (CI.Primitive CI.Int64_t,
  ...
  "c_eigen_dsmat_s_get" ->
  (fun x558 x560 x561 ->
    owl_stub_3_c_eigen_dsmat_s_get (CI.cptr x558) x560 x561)
| Function (CI.Pointer x563, Returns CI.Void), "c_eigen_dsmat_s_delete" ->
  (fun x562 -> owl_stub_2_c_eigen_dsmat_s_delete (CI.cptr x562))
| Function
    (CI.Primitive CI.Int64_t,
     Function (CI.Primitive CI.Int64_t, Returns (CI.Pointer x566))),
  "c_eigen_dsmat_s_new" ->
  (fun x564 x565 ->
    CI.make_ptr x566 (owl_stub_1_c_eigen_dsmat_s_new x564 x565))
