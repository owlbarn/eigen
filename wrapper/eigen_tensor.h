 ...
 */
 ...
 typedef int64_t INDEX;
   ...
   void c_eigen_tensor_s_spatial_max_pooling_backward(tensor_s_elt*, tensor_s_elt*, tensor_s_elt*, int, int, int, int, int, int, int, int, int, int, int, int);
   void c_eigen_tensor_s_spatial_avg_pooling_backward(tensor_s_elt*, tensor_s_elt*, int, int, int, int, int, int, int, int, int, int, int, int);
   ...
   void c_eigen_tensor_d_spatial_max_pooling_argmax(tensor_d_elt*, tensor_d_elt*, INDEX*, int, int, int, int, int, int, int, int, int, int, int, int);
   void c_eigen_tensor_d_spatial_max_pooling_backward(tensor_d_elt*, tensor_d_elt*, tensor_d_elt*, int, int, int, int, int, int, int, int, int, int, int, int);
   void c_eigen_tensor_d_spatial_avg_pooling_backward(tensor_d_elt*, tensor_d_elt*, int, int, int, int, int, int, int, int, int, int, int, int);
